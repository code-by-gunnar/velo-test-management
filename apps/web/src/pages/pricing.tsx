          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-14">
              ...
              <nav className="flex items-center gap-3">
                ...
                <Link href="/features" className="text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-md transition-colors px-2.5 py-1.5">
                  Features
                </Link>
                <Link href="/pricing" className="text-sm font-medium text-primary px-2.5 py-1.5">
                  Pricing
                </Link>
