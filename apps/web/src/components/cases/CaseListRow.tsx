      ...
      <td className="w-8 px-2 py-2.5">
        {canEdit && (
          <span
            {...attributes}
            {...listeners}
            className="flex cursor-grab items-center justify-center rounded text-gray-500 hover:text-gray-700 select-none active:cursor-grabbing focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
